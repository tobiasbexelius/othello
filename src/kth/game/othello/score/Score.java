...
public interface Score {
	 ...
	 * {@link List} of {@link String}s with the ids of the players that had a change of the score will be sent.
	 * 
	...
	/**
	 * A list of the score of all players. The list is sorted in decreasing order regarding the score, that is the
	 * leader
	 * 
